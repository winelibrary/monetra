...
Gem::Specification.new do |s|
  ...
  s.authors = ["Dan Ahern"]
  s.cert_chain = ["/Users/danahern/.ssh/gem-public_cert.pem"]
  s.date = %q{2010-09-11}
  ...
  s.files = ["Manifest", "Rakefile", "lib/monetra.rb", "lib/monetra/configuration.rb", "lib/monetra/connection.rb", "lib/monetra/transaction.rb", "lib/monetra/transaction/admin.rb", "lib/monetra/transaction/engine.rb", "lib/monetra/transaction/token.rb", "lib/monetra/transaction/user.rb", "monetra.gemspec"]
  ...
  s.signing_key = %q{/Users/danahern/.ssh/gem-private_key.pem}
